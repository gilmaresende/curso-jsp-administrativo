                ...
                <div class="about-text">
                    ...
                    <div class="at-feature">
                        ...
                        <div class="af-item">
                            ...
                            <div class="af-text">
                                <h6>Suas compras facilitadas</h6>
                        ...
                        <div class="af-item">
                            ...
                            <div class="af-text">
                                <h6>Consultores Especializados</h6>
            ...
            <div class="col-md-4">
                <div class="ts-item">
                    <div class="ts-text">
                        ...
                        <h5>Nome do corretor</h5>
                        <span><i class="fa fa-whatsapp mr-1"></i> (31) 9 9812-3456</span>
                        <p>Ipsum dolor amet, consectetur adipiscing elit, eiusmod tempor incididunt lorem.</p>
                        <div class="ts-social">
                            <a href="#"><i class="fa fa-facebook"></i></a>
                            <a href="#"><i class="fa fa-twitter"></i></a>
                            <a href="#"><i class="fa fa-envelope-o"></i></a>
                            <a class="text-white" target="_blank" href="http://api.whatsapp.com/send?1=pt_BR&phone="><i class="fa fa-whatsapp mr-1"></i></a>
                        </div>
                    </div>
                </div>
            </div>
